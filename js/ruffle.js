(() => {
  ...
  (r.m = t),
    ...
    (r.u = (e) =>
      "core.ruffle." +
      { 482: "7020c4cdffbc0d672689", 655: "d8020f36e5918e887c19" }[e] +
      ".js"),
    (r.g = (function () {
  ...
  function A(e, n) {
    ...
    for (const r of n)
      "narg" === r.type ? (a[r.name] = q(e, r.value)) : t.push(q(e, r));
    ...
    switch (n.type) {
      ...
      case "term":
        return (function (e, { name: n, attr: t, args: a }) {
          ...
          if (!o)
            return (
              e.reportError(new ReferenceError(`Unknown term: ${r}`)), new z(r)
            );
          if (t) {
    ...
    formatPattern(e, n = null, t = null) {
      ...
      try {
        ...
        if (a.errors && e instanceof Error)
          return a.errors.push(e), new z().toString(a);
        throw e;
      }
    }
  }
  ...
  class de {
    constructor(e) {
      ...
      function u(a = [], r) {
        ...
        let l = [];
        for (let e of a)
          e instanceof fe && (e = e.value.slice(0, e.value.length - r)),
            e && l.push(e);
        return l;
      }
      function c() {
  ...
  class pe {
    ...
    addLikelySubtags() {
      const e = (function (e) {
        ...
        const n = new pe(e);
        if (n.language && ve.includes(n.language))
  ...
  for (const [e, n] of Object.entries(Re)) {
    ...
    if (n) {
      ...
      for (const [r, o] of Object.entries(n))
        if (o) {
          a ??= be();
          for (const n of t.addResource(new de(o)))
  ...
  const Ue = {
    OpenDemo: {
      type: "open_link",
      url: Oe + "/demo",
      label: je("ruffle-demo"),
    },
    DownloadDesktop: {
      type: "open_link",
      url: Oe + "/downloads#desktop-app",
      label: je("ruffle-desktop"),
    },
    UpdateRuffle: {
      type: "open_link",
      url: Oe + "/downloads",
      label: je("update-ruffle"),
    },
      ...
      { body: o, actions: i } = (function (e) {
        if (e instanceof Ie)
          return e.swfUrl && !e.swfUrl.protocol.includes("http")
            ? {
                body: Se("error-file-protocol"),
                actions: [Ue.OpenDemo, Ue.DownloadDesktop],
              }
            ...
            : {
                ...
                actions: [
                  Ue.openWiki("Using-Ruffle#configure-cors-header"),
                  Ue.ShowDetails,
                ],
              };
        if (e instanceof Te)
          return { body: Se("error-invalid-swf"), actions: [Ue.ShowDetails] };
        if (e instanceof We) {
          ...
          if (n.includes("mime"))
            return {
              ...
              actions: [
                Ue.openWiki("Using-Ruffle#configure-webassembly-mime-type"),
                Ue.ShowDetails,
              ],
            };
          if (
          ...
          if (n.includes("disallowed by embedder"))
            return {
              ...
              actions: [
                Ue.openWiki("Using-Ruffle#configure-wasm-csp"),
                Ue.ShowDetails,
              ],
            };
          if ("CompileError" === e.cause.name && n.includes("bad type"))
            return {
              body: Se("error-wasm-unsupported-browser"),
              actions: [Ue.openWiki("#web"), Ue.ShowDetails],
            };
          ...
          if (
            ...
            return {
              body: Se("error-wasm-download"),
              actions: [Ue.ShowDetails],
            };
          if ("TypeError" === e.cause.name) {
            ...
            return (
              _e() &&
                e.appendChild(
                  Se("error-javascript-conflict-outdated", {
          ...
          return navigator.userAgent.includes("Edg") &&
            ...
            : {
                ...
                actions: [
                  Ue.openWiki("Using-Ruffle#configuration-options"),
                  Ue.ShowDetails,
                ],
              };
        }
        return e instanceof Le
          ? {
              ...
              actions: [
                Ue.openWiki("Using-Ruffle#javascript-api"),
                Ue.ShowDetails,
              ],
            }
          : {
              body: Se("error-unknown", {
                buildDate: l.buildDate,
                outdated: String(_e),
              }),
      ...
      u = () => {
        s.current.classList.add("details"),
          s.current.replaceChildren(
            (0, y.jsx)("textarea", { readOnly: !0, children: r })
          );
      };
    (e.textContent = ""),
      e.appendChild(
  ...
  async function Ge(e) {
    null === Qe &&
      (Qe = (async function (e) {
        ye();
        const n = (await Promise.all([Ve(), Ke(), Je(), Ze(), He()])).every(
          Boolean
        );
        n ||
          console.log(
      ...
      for (; a < 999; ) {
        ...
        if (
          ...
          return (
            ...
            (Ye[e] = { class: n, name: t, internalName: e }),
            t
          );
        a += 1;
      }
  ...
  class sn {
    constructor(e, n, t) {
      ...
      a &&
        ...
        (a.innerText = je("save-backup-all")));
    ...
    async ensureFreshInstance() {
      ...
      const [e, n] = await Ge(this.onRuffleDownloadProgress.bind(this)).catch(
        (e) => {
        ...
        if (!fn(this.element))
          try {
            (this.loadedConfig = {
              ...R,
              ...(n && "url" in e
                ? { allowScriptAccess: gn("samedomain", e.url) }
                : {}),
    ...
    confirmReloadSave(e, n, t) {
      if (hn(n) && localStorage[e]) {
        ...
        if (a.includes(o) && e.startsWith(r)) {
          return void (
            confirm(
              je("save-reload-prompt", { action: t ? "replace" : "delete" })
            ) &&
            this.loadedConfig &&
            (this.destroy(),
      ...
      (e.textContent = ""),
        Object.keys(localStorage).forEach((n) => {
          ...
          t &&
            ...
            hn(a) &&
            e.appendChild(
              (0, y.jsx)(this.SaveRow, { rowKey: n, solName: t, solData: a })
            );
        });
    }
    async backupSaves() {
    ...
    contextMenuItems() {
      ...
      return (
        this.fullscreenEnabled &&
          (this.isFullscreen
            ? n.push({
                text: je("context-menu-exit-fullscreen"),
                onClick: async () => this.setFullscreen(!1),
              })
            : n.push({
                text: je("context-menu-enter-fullscreen"),
        ...
        this.instance &&
          ...
          (t(),
          n.push({
            text: je("context-menu-download-swf"),
        ...
        this.checkSaves() &&
          n.push({
            text: je("context-menu-open-save-manager"),
            onClick: this.openSaveManager.bind(this),
          }),
        t(),
        n.push({
          text: je("context-menu-about-ruffle", {
            flavor: $e ? "extension" : "",
    ...
    panic(e) {
      ...
      t.push(this.getPanicData()),
        Be(this.container, n, t, this.swfUrl),
        this.destroy();
    }
    ...
    displayClipboardModal(e) {
      ...
      n &&
        ((n.textContent = je("clipboard-message-description", {
            ...
            (e) => {
              try {
                Object.defineProperty(this, e, {
                  value: (...n) =>
                    zn(this, Rn, "f").callExternalInterface(e, n),
                  configurable: !0,
                });
              } catch (n) {
                console.warn(
  ...
  class qn extends Sn {
    ...
    static fromNativeObjectElement(e) {
      ...
      for (const n of Array.from(e.getElementsByTagName("embed")))
        En.isInterdictable(n) && n.remove();
      for (const n of Array.from(e.getElementsByTagName("object")))
        qn.isInterdictable(n) && n.remove();
      return Cn(e, t), t;
    }
    get height() {
      return this.getAttribute("height") || "";
  ...
  function Yn() {
    try {
      (Zn = Zn ?? document.getElementsByTagName("object")),
        (Kn = Kn ?? document.getElementsByTagName("embed"));
    ...
    if ($e || void 0 === t.documentElement.dataset.ruffleOptout)
      if ($e)
        e.RufflePlayer || (e.RufflePlayer = {}),
          (e.RufflePlayer.config = { ...Hn, ...(e.RufflePlayer.config ?? {}) });
    ...
    !(function (e) {
      ...
      ("install" in navigator.plugins && navigator.plugins.install) ||
        ...
        Object.defineProperty(navigator, "plugins", {
          value: new Bn(navigator.plugins),
          writable: !1,
        })),
        ...
        !(e.length > 0) ||
          ...
          Object.defineProperty(navigator, "mimeTypes", {
            value: new Nn(navigator.mimeTypes),
            writable: !1,
          }));
